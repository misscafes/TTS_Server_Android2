  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(28) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsPlugin = new HashMap<String, TableInfo.Column>(12);
        ...
        _columnsPlugin.put("audioParams", new TableInfo.Column("audioParams", "TEXT", true, 0, "'{}'", TableInfo.CREATED_FROM_ENTITY));
